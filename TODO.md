...
- FIXME@P1 Trying to upgrade package manager, "Error from Canister eczl5-ih777-77774-qadoa-cai: Canister called `ic0.trap` with message: 'IDL error: did not find field battery in record'"
