...
generate@Bootstrapper: canister@Bootstrapper \
...
generate@BootstrapperData: canister@BootstrapperData \
...
generate@Repository: canister@Repository \
...
generate@bookmark: canister@bookmark \
...
generate@bootstrapper_frontend: canister@bootstrapper_frontend \
...
generate@cycles_ledger: canister@cycles_ledger \
...
generate@example_backend: canister@example_backend \
...
generate@example_frontend: canister@example_frontend \
...
generate@indirect_caller: canister@indirect_caller \
...
generate@package_manager: canister@package_manager \
...
generate@package_manager_frontend: canister@package_manager_frontend \
...
generate@simple_indirect: canister@simple_indirect \
...
deploy-self@Repository: canister@Repository
