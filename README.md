...
### Pending mint eviction

To prevent unlimited growth of pending token deliveries, the wallet now keeps
at most 1000 outstanding mint records. Older entries are automatically dropped
after a week. When too many pending mints exist, new investments are rejected
until some entries are processed.

If your mint request was evicted before completion, contact the project
maintainers with proof of your investment so it can be minted manually.
